        ...
        <div className="flex flex-col justify-center items-center font-roboto-mono font-light mx-5 leading-[1.8] sm:mx-20 md:mx-40 lg:mx-60">
          ...
          <p className="text-center text-md my-5">
            {projectDetails
              ...
              : `Project: ${id} not found`}
            <br />
            {projectDetails ? projectDetails.stack : `Project: ${id} not found`}
            <br />
          </p>

          <div
            className={`flex flex-col text-center text-md ml-5 ${
              isDarkMode ? "text-blue-500" : "text-light-mode-color"
            }`}
          >
            ...
            projectDetails.paragraphs.map((para, index) => {
              ...
              return (
                <React.Fragment key={index}>
                  <p className="text-left font-roboto-mono font-light my-5">
                    {para}
                  </p>
