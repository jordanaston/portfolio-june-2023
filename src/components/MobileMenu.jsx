...
function MobileMenu() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`
          fixed inset-0 flex items-center justify-start z-50 transition-transform duration-300 bg-light-mode-color
        ...
        <ul className="flex flex-col items-start ml-4 font-roboto-mono justify-center h-full space-y-10">
          <li>
            <Link
              to="/"
              onClick={handleClick}
              className="block text-5xl font-light ml-2 text-dark-mode-color"
              style={linkStyles}
